...
$(function () {
    ...
    /*
        先将头像提交到文件服务器上，成功以后再将头像的地址保存到数据库中
        提交用户头像的图片数据：将数据提交到文件服务器上
     */
    $("#submitEditAvatar").on("click", function () {
        var file_server = $("meta[name='file_server']").attr("content");
        ...
        console.log("图片上传到文件服务器！");
        console.log(formData);
        if(formData === null) {
            toastr.error("请正确上传头像");
        }
        $.ajax({
            // 文件服务器地址
